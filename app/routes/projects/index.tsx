...
const PROJECTS: Project[] = [
  {
    title: "HRIS System",
    description:
      "A full Human Resource Information System with employee management, payroll, attendance tracking, and role-based access control.",
    link: "#",
  ...
  },
  {
    ...
    description:
      "UI/UX design and front-end development for a hotel resort website with an integrated booking system and reservation flow.",
    link: "#",
  ...
  },
  {
    title: "Calqlation",
    description:
      "Interactive online quiz web app for college students with intuitive UX flow and real-time scoring.",
    link: "#",
  ...
  },
  {
    title: "Caffetize",
    description:
      "Full front-end UI for a coffee shop website covering layout, typography, and brand visuals.",
    link: "#",
  ...
  },
  {
    title: "C&C Wear",
    description:
      "Front-end website for a streetwear shoe brand, emphasizing visual identity and product showcase.",
    link: "#",
    tags: ["React", "CSS"],
    category: "E-commerce",
  },
  {
    title: "Pinotax",
    description:
      "Accounting platform with a clean, functional interface built for small-business tax and bookkeeping workflows.",
    link: "#",
  ...
  },
  {
    ...
    description:
      "Outsourcing company website designed and developed from concept to deployment.",
    link: "#",
  ...
  },
  {
    title: "Kiefer Prints",
    description:
      "Printing services website handling UI design and front-end implementation for a local print shop.",
    link: "#",
    tags: ["PHP", "MySQL", "CSS"],
...
function ProjectCard({ project }: { project: Project }) {
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`group relative flex flex-col justify-between gap-5 overflow-hidden rounded-2xl p-6 transition-all duration-300 ${
