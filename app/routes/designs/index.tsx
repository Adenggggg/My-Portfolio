...
const artDesigns: { title: string; image: string; category?: string }[] = [
  ...
  { title: "Covid",           image: "/arts/Infograph1.png",  category: "Infographics" },
  { title: "Covid",           image: "/arts/Infograph2.png",  category: "Infographics" },
  { title: "Covid",           image: "/arts/Infograph3.png",  category: "Infographics" },
          ...
          >
            ...
            <div
              ...
              style={{
                ...
                left: activeTab === "figma" ? "4px" : "calc(50%)",
              }}
            />
            ...
            {([
              ...
              <button
                ...
                style={{ color: activeTab === tab.value ? "var(--btn-text)" : "var(--text-3)" }}
              >
                {tab.icon}
                {tab.label}
              </button>
          ...
          <div className="flex flex-col items-center justify-center py-24 text-center">
            ...
            >
              {activeTab === "figma" ? (
                ...
                <svg viewBox="0 0 24 24" width="28" height="28" fill="none" stroke="currentColor" strokeWidth="1.5" style={{ color: "var(--text-3)" }}>
                  <path d="M12 2C6.5 2 2 6.5 2 12s4.5 10 10 10c.926 0 1.648-.746 1.648-1.688 0-.437-.18-.835-.437-1.125-.29-.289-.438-.652-.438-1.125a1.64 1.64 0 0 1 1.668-1.668h1.996c3.051 0 5.555-2.503 5.555-5.554C21.965 6.012 17.461 2 12 2z"/>
                </svg>
              )}
            </div>
          ...
          <div key={activeTab} className="columns-2 gap-4 space-y-4 md:columns-3">
            {items.map((design, i) => (
              ...
              >
                ...
                />
                <div
                  className="absolute inset-0 flex items-end justify-between p-4 opacity-0 transition-opacity group-hover:opacity-100"
